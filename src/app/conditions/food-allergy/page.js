...
export const metadata = {
  ...
  description: "Advanced diagnostic mapping for food sensitivities and allergies in Hyderabad. Expert clinical management by Dr. Vyakarnam Nageshwar.",
  keywords: "food allergy testing Hyderabad, nut allergy treatment, gluten sensitivity, Dr. Vyakarnam Nageshwar, allergen forensic lab",
};
...
export default function FoodAllergyPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Dr. Nageshwar's research has identified a high prevalence of yeast hypersensitivity in India, which can complicate other allergies and even impact vaccine safety. We are one of the few labs screening for this specifically."
    }
  ];
